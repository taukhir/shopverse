...
public class RequestLoggingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try (org.slf4j.MDC.MDCCloseable ignored =
            ...
            log.info("Inventory service request started method={} path={}", request.getMethod(), request.getRequestURI());
            try {
                filterChain.doFilter(request, response);
            } finally {
            ...
            meterRegistry.counter(
                    REQUEST_COUNTER,
                    "service", InventoryConstants.SERVICE_NAME,
            ...
            log.info(
                    "Inventory service request completed method={} path={} status={} durationMs={}",
                    request.getMethod(),

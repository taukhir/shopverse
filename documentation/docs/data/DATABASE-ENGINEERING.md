...
For the complete lead/architect learning sequence, production scenarios, and coverage
map, start with [Database Production Mastery](./DATABASE-PRODUCTION-MASTERY.md).

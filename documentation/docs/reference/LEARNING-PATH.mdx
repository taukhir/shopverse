...
|---|---|
| Java backend | [Core Java Deep Dive](../java/CORE-JAVA-DEEP-DIVE.md) -> [Collections guide](../java/JAVA-COLLECTIONS-UMBRELLA.md) -> [Threads and concurrency](../java/JAVA-THREADING-UMBRELLA.md) -> [Spring Ecosystem](../spring/SPRING-ECOSYSTEM.md) -> [Spring REST APIs](../development/SPRING-REST-APIS.md) |
...
| Collections | [Java Collections Guide](../java/JAVA-COLLECTIONS-UMBRELLA.md) | Select lists, sets, maps, queues, iterators, hashing, and concurrent collections correctly |

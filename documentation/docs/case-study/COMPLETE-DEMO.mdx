...
page_type: Runbook
status: Implemented
prerequisites: [Running full Shopverse stack, Demo credentials]
learning_objectives: [Demonstrate secure checkout and SAGA completion, Verify failure recovery outbox and observability evidence]
technologies: [PowerShell, Docker, Kafka, Spring Boot]

...
| 8 | [Observability](../observability/OBSERVABILITY.md) | How are logs, metrics, and traces connected? |
| 9 | [Testing strategy](../development/TESTING.md) | How is the ecosystem verified without unbounded resource use? |
| 10 | [Problems and solutions](../reliability/PROBLEMS-AND-SOLUTIONS.md) | Which production-relevant defects were found and fixed? |

...
|---|---|---|
| Runtime reliability | [Runtime Reliability Problems](./RUNTIME-RELIABILITY-PROBLEMS.md) | Checkout consistency, idempotency, Kafka behavior, reservation expiry, ownership checks. |

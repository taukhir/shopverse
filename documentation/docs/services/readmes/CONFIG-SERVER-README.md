...
sidebar_label: Config Server README
...
> This page is generated from the canonical [config-server/README.md](https://github.com/taukhir/shopverse/blob/main/config-server/README.md).
> Repository-relative source links are rewritten for the documentation site.

# Shopverse Config Server

Cross-cutting architecture and service ownership are documented in the [Shopverse documentation index](../../README.mdx). This README remains focused on Config Server operation and refresh behavior.
...
More Docker commands, flags, Dockerfile details, and the Config Server Compose block explanation are in [../docker/README.md](https://github.com/taukhir/shopverse/blob/main/docker/README.md).
...
Follow scoped [`AGENTS.md`](https://github.com/taukhir/shopverse/blob/main/config-server/AGENTS.md), imported by [`CLAUDE.md`](https://github.com/taukhir/shopverse/blob/main/config-server/CLAUDE.md).
...
and observability configuration. Use the root [`AGENTS.md`](https://github.com/taukhir/shopverse/blob/main/AGENTS.md),
[incident workflow](https://github.com/taukhir/shopverse/blob/main/ai-workflows/prompts/incident-investigation.md), and

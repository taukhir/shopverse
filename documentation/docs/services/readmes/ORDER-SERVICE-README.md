...
sidebar_label: Order Service README
...
> This page is generated from the canonical [order-service/README.md](https://github.com/taukhir/shopverse/blob/main/order-service/README.md).
...
This module has scoped [`AGENTS.md`](https://github.com/taukhir/shopverse/blob/main/order-service/AGENTS.md) guidance imported by
[`CLAUDE.md`](https://github.com/taukhir/shopverse/blob/main/order-service/CLAUDE.md). Start with:

- [Implement a bounded feature](https://github.com/taukhir/shopverse/blob/main/ai-workflows/prompts/implement-feature.md)
- [Debug distributed checkout](https://github.com/taukhir/shopverse/blob/main/ai-workflows/prompts/debug-distributed-checkout.md)
- [Review a Kafka consumer](https://github.com/taukhir/shopverse/blob/main/ai-workflows/prompts/review-kafka-consumer.md)

...
sidebar_label: User Service README
...
> This page is generated from the canonical [user-service/README.md](https://github.com/taukhir/shopverse/blob/main/user-service/README.md).
...
logging. Follow scoped [`AGENTS.md`](https://github.com/taukhir/shopverse/blob/main/user-service/AGENTS.md), imported by
[`CLAUDE.md`](https://github.com/taukhir/shopverse/blob/main/user-service/CLAUDE.md), and use the

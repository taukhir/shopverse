...
/* harmony import */ var _chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(65310);
/* harmony import */ var _chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(26460);
...
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(20271);
...
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(91672);
/* harmony import */ var _upsetjs_venn_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(11832);
/* harmony import */ var roughjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(52274);
...
var addSubsetData = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((identifierList, label, size) => {
...
var getSubsetData = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => {
  return subsets;
}, "getSubsetData");
var normalizeText = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((text) => {
...
var normalizeStyleValue = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((value) => {
  return value ? normalizeText(value) : value;
}, "normalizeStyleValue");
var addTextData = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((identifierList, id, label) => {
...
var addStyleData = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((identifierList, data) => {
...
var getStyleData = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => {
  return styleEntries;
}, "getStyleData");
var normalizeIdentifierList = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((identifierList) => {
  return identifierList.map((identifier) => normalizeText(identifier));
}, "normalizeIdentifierList");
var validateUnionIdentifiers = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((identifierList) => {
...
var getTextData = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => {
  return textNodes;
}, "getTextData");
var getCurrentSets = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => currentSets, "getCurrentSets");
var getIndentMode = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => indentMode, "getIndentMode");
var setIndentMode = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((enabled) => {
  indentMode = enabled;
}, "setIndentMode");
var DEFAULT_VENN_CONFIG = _chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_2__/* .defaultConfig_default */ .UI.venn;
function getConfig2() {
  return (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .cleanAndMerge */ .$t)(DEFAULT_VENN_CONFIG, (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig */ .zj)().venn);
}
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getConfig2, "getConfig");
var customClear = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => {
...
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(buildStyleByKey, "buildStyleByKey");
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((_text, id, _version, diagObj) => {
  const db2 = diagObj.db;
  const config = db2.getConfig?.();
  const { themeVariables, look, handDrawnSeed } = (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig */ .zj)();
  ...
  const dummyD3root = (0,d3__WEBPACK_IMPORTED_MODULE_4__/* .select */ .Ltv)(document.createElement("div"));
  const vennDiagram = _upsetjs_venn_js__WEBPACK_IMPORTED_MODULE_9__/* .VennDiagram */ .py().width(svgWidth).height(svgHeight - titleHeight);
  dummyD3root.datum(sets).call(vennDiagram);
  const roughSvg = isHandDrawn ? roughjs__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .A.svg(dummyD3root.select("svg").node()) : void 0;
  const layoutAreas = _upsetjs_venn_js__WEBPACK_IMPORTED_MODULE_9__/* .layout */ .Zp(sets, {
    width: svgWidth,
  ...
  const themeDark = (0,khroma__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A)(themeVariables.background || "#f4f4f4");
  dummyD3root.selectAll(".venn-circle").each(function(d, i) {
    const group = (0,d3__WEBPACK_IMPORTED_MODULE_4__/* .select */ .Ltv)(this);
    const data = d;
    ...
    if (isHandDrawn && roughSvg) {
      ...
      if (layoutArea && layoutArea.circles.length > 0) {
        ...
        const roughNode = roughSvg.circle(c.x, c.y, c.radius * 2, {
          roughness: 0.7,
          seed: handDrawnSeed,
          fill: (0,khroma__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A)(baseColor, 0.7),
          fillStyle: "hachure",
          fillWeight: 2,
          hachureGap: 8,
    ...
    const textColor = customStyle?.color || (themeDark ? (0,khroma__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A)(baseColor, 30) : (0,khroma__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A)(baseColor, 30));
      ...
      if (customFill) {
        ...
        if (pathD) {
          const roughNode = roughSvg.path(pathD, {
            roughness: 0.7,
            seed: handDrawnSeed,
            fill: (0,khroma__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A)(customFill, 0.3),
  ...
  (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_2__/* .configureSvgSize */ .a$)(svg, svgHeight, svgWidth, config?.useMaxWidth ?? true);
}, "draw");
function stableSetsKey(setIds) {
  return setIds.join("|");
}
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(stableSetsKey, "stableSetsKey");
...
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(renderTextNodes, "renderTextNodes");
var renderer = { draw };

...
const next = new Map([
  ['ai/JAVA-AI-CODE-COOKBOOK.md','[AI Development Interview Workbook](./AI-DEVELOPMENT-INTERVIEW-WORKBOOK.md)'],
  ['ai/LANGCHAIN4J-DEEP-DIVE.md','[LangChain4j Tutorials](./LANGCHAIN4J-TUTORIALS.md)'],
  ['architecture/CHANGE-DATA-CAPTURE.md','[Transactional Outbox Pattern](../reliability/OUTBOX-PATTERN.md)'],
  ...
  ['architecture/hld-lld/PERFORMANCE-CAPACITY-MODELS.md','[Capacity And Performance Estimation](./CAPACITY-PERFORMANCE-ESTIMATION.md)'],
  ['architecture/SYSTEM-DESIGN.md','[Shopverse Case Study](../case-study/SHOPVERSE.mdx)'],
  ...
  ['case-study/COMPLETE-DEMO.mdx','[Demo Setup And Checkout](./COMPLETE-DEMO-SETUP-CHECKOUT.mdx)'],
  ['case-study/COMPLETE-DEMO-SETUP-CHECKOUT.mdx','[Demo Recovery And Observability](./COMPLETE-DEMO-RECOVERY-OBSERVABILITY.mdx)'],
  ['case-study/COMPLETE-DEMO-RECOVERY-OBSERVABILITY.mdx','[Features And Demos](../reference/FEATURES-AND-DEMOS.md)'],
  ['case-study/SHOPVERSE-ONBOARDING-ARCHITECTURE-AUDIT.md','[Shopverse System Design](../architecture/SYSTEM-DESIGN.md)'],
  ['data/DATABASE-ENGINEERING.md','[Database Production Mastery](./DATABASE-PRODUCTION-MASTERY.md)'],
  ...
  ['data-structures/programming/arrays/ARRAY-30-PROBLEM-ROADMAP.md','[Array Problems 1-10](./ARRAY-PROBLEMS-01-10.md)'],
  ['development/API-GATEWAY-GENERIC.md','[Service Discovery](../architecture/SERVICE-DISCOVERY.md)'],
  ['development/DEBUGGING.md','[Debugging Data, Saga, And Kafka](./DEBUGGING-DATA-SAGA-KAFKA.md)'],
  ['development/DESIGN-PATTERNS.md','[Design Pattern Selection Cheatsheet](./design-patterns/DESIGN-PATTERN-SELECTION-CHEATSHEET.md)'],
  ['development/ENGINEERING-PRINCIPLES.md','[Testing Strategy](./TESTING.md)'],
  ['development/TESTING.md','[Testing Modes And CI Triage](./TESTING-MODES-CI-TRIAGE.md)'],
  ...
  ['observability/MDC-CORRELATION-TRACING.md','[Micrometer Metrics](./MICROMETER-METRICS.md)'],
  ['operations/DEPLOYMENT-STRATEGIES.md','[Kubernetes Architect Path](./KUBERNETES-ARCHITECT-PATH.md)'],
  ['operations/DOCUSAURUS.md','[Docusaurus Authoring And Navigation](./DOCUSAURUS-AUTHORING-NAVIGATION.md)'],
  ['operations/GIT-COMMANDS.md','[GitHub Actions](./GITHUB-ACTIONS.md)'],
  ['operations/DOCKER.md','[Docker Internals, Layers, And Storage](./DOCKER-INTERNALS-LAYERS-STORAGE.md)'],
  ['reference/FEATURES-AND-DEMOS.md','[Complete Demo](../case-study/COMPLETE-DEMO.mdx)'],
  ['reference/LEARNING-PATH.mdx','[Shopverse Case Study](../case-study/SHOPVERSE.mdx)'],
  ['reliability/problems/runtime/ATOMIC-RESERVATION-CLAIM.md','[Multi-Replica Reservation Expiry](./MULTI-REPLICA-RESERVATION-EXPIRY.md)'],
  ['reliability/problems/runtime/RESOURCE-OWNERSHIP-AUTHORIZATION.md','[JWT And Spring Security](../../../security/JWT-OAUTH2-SPRING-SECURITY.md)'],
  ['reliability/RESILIENCE4J-GENERIC.md','[Shopverse Resilience4j](./RESILIENCE4J.md)'],
  ['reliability/SAGA-GENERIC.md','[Shopverse Saga And Outbox](./SAGA-OUTBOX.md)'],
  ['security/ACCESS-REFRESH-API-KEY-IMPLEMENTATION-GUIDE.md','[Security Architect Path](./platform/SECURITY-ARCHITECT-PATH.md)'],
  ['security/JWT-OAUTH2-SPRING-SECURITY.md','[OAuth2 And OIDC Flows](./spring-security/OAUTH2-OIDC-FLOWS.md)'],

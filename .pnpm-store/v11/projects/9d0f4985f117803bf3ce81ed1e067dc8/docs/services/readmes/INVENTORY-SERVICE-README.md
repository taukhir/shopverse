...
sidebar_label: Inventory Service README
...
> This page is generated from the canonical [inventory-service/README.md](https://github.com/taukhir/shopverse/blob/main/inventory-service/README.md).
...
This module has scoped [`AGENTS.md`](https://github.com/taukhir/shopverse/blob/main/inventory-service/AGENTS.md) guidance imported by
[`CLAUDE.md`](https://github.com/taukhir/shopverse/blob/main/inventory-service/CLAUDE.md). Useful reviewed workflows include:

- [Kafka consumer review](https://github.com/taukhir/shopverse/blob/main/ai-workflows/prompts/review-kafka-consumer.md)
- [Distributed checkout debugging](https://github.com/taukhir/shopverse/blob/main/ai-workflows/prompts/debug-distributed-checkout.md)
- [Performance optimization](https://github.com/taukhir/shopverse/blob/main/ai-workflows/prompts/optimize-performance.md)
...
- [Scheduler locking with ShedLock](../../reliability/locking/SCHEDULER-LOCKING-SHEDLOCK.md)

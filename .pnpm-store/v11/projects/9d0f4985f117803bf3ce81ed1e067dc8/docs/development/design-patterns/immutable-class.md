...
```mermaid
flowchart LR
    Input["Mutable input"] --> CopyIn["Defensive copy"] --> Object["Immutable object"]
    Object --> Read["Read-only operation"]
    Object --> CopyOut["Defensive copy or immutable view"] --> Caller
```

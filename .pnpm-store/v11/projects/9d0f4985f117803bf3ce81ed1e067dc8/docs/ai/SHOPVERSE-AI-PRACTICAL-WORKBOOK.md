...
```mermaid
flowchart LR
    T["Select a Shopverse task"] --> I["Inspect ownership and invariants"] --> M["Make the smallest change"]
    M --> Q["Run narrow verification"] --> B["Run broader checks"] --> H["Record evidence and residual risk"]
```
